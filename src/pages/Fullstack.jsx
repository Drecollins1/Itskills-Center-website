      ...
      <div className=" mt-14 max-w-7xl mx-auto">
        <div className=" hero lg:flex items-center py-8">
          <div className="flex flex-col gap-3 p-5 lg:w-[50%] mt-[-80px] ">
            ...
            Full-stack Developer. Throughout bootcamp, you should build a
            variety of case studies and publish your job-ready Full-stack
            Developer portfolio.
            </p>
          ...
          <img src="../../Assets/fullstackimage.png" alt="" />
          </div>
        </div>
        <Curriculum
        price={<h1>NGN 550,000</h1>}
        certified={"Full-Stack bootcamp"}
        design={"Full-Stack Classes"}
        workshop={"Full-Stack Workshop"}
        series={"Create Full-Stack Project"}
      />
      </div>
      <MentorsAndAlumni />
      <AlumniSection />
