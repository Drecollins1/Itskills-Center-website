      ...
      <div className=" mt-14 max-w-7xl mx-auto">
        <div className=" hero lg:flex items-center py-8">
          <div className="flex flex-col gap-3 p-5 lg:w-[50%] mt-[-80px] ">
            ...
            Mobile App development Our bootcamp will help you launch or advance
            your career as a Mobile App developer. Throughout bootcamp, you
            should build a variety of case studies and publish your job-ready
          ...
          <img src="../../Assets/mobileimage.png" alt="" />
          </div>
        </div>
        <Curriculum
        price={<h1>NGN 500,000</h1>}
        certified={"Mobile App Development bootcamp"}
        design={"Mobile App Development Classes"}
        workshop={"Mobile App Development Workshops"}
        series={"Create Mobile App Development Project"}
      />
      </div>
      <MentorsAndAlumni />
      <AlumniSection />
